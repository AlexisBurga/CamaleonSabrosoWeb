...
<body>
    ...
    <div style="text-align: center;">
        <button class="btn-agregar" onclick="window.location.href='/camaleonweb/envios/findOne?opcion=1'; return false;">
            ...
            <tbody id="tableBody">
                <c:forEach var="item" items="${envios}">
                    <tr>
                        ...
                        <td> 
                            <button class="btn-actualizar" onclick="window.location.href='/camaleonweb/envios/findOne?idEnvios=${item.idEnvios}&opcion=1'; return false;">
                                <i class="fa-solid fa-pen-to-square"></i> Actualizar
                            </button>
                            <button class="btn-eliminar" onclick="window.location.href='/camaleonweb/envios/findOne?idEnvios=${item.idEnvios}&opcion=2'; return false;">
