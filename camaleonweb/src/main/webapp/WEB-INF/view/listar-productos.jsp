...
<section class="px-5 py-5">
    <div class="container">
        ...
        <div class="search-container">
            ...
            <button class="btn btn-primary" onclick="window.location.href='/camaleonweb/productos/findOne?opcion=1'; return false;">
                    ...
                    <tbody>
                        <c:forEach var="item" items="${productos}">
                            <tr>
                                ...
                                <td>${item.stock}</td>
                                <td>
                                    <button class="btn btn-success" onclick="window.location.href='/camaleonweb/productos/findOne?idProducto=${item.idProducto}&opcion=1'; return false;">
                                        <i class="fa-solid fa-pen-to-square"></i> Actualizar
                                    </button>
                                    <button class="btn btn-danger" onclick="window.location.href='/camaleonweb/productos/findOne?idProducto=${item.idProducto}&opcion=2'; return false;">
